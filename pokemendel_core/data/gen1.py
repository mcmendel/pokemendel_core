...
class PokemonGen1:
    """Generation 1 Pokémon names.
    
    This class contains string constants for all 151 original Pokémon from Generation 1.
    ...
    - Special characters (e.g., "Farfetch'd", "Mr. Mime")
